      ...
      {viewCalender ? (
        <View>
          ...
          <ScheduleHeader onPress={() => setViewCalender(!viewCalender)}/>
            <CalenderScreen minDate={moment().subtract(1, 'day')}
                            onDayPress={(day) => {console.log('selected day', day)}}
                            renderHeader={(date) => {return (<View></View>)}}
        ...
        <View>
          <SafeAreaView>
            <View style={[styles.container, {backgroundColor: theme.cardBg}]}>
              ...
              <Text style={[styles.subHeading, { color: theme.cardTextHeading }]}>Upcoming</Text>
              <ScrollView horizontal={true} showsVerticalScrollIndicator={false} style={{height: 200, marginLeft: 20, paddingTop: 20, marginRight: 20}}>
                <View
                  style={{
                    paddingRight: 20,
                  }}>
